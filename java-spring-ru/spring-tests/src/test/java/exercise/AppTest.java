...
public class AppTest {
    ...
    void testGetPersons() throws Exception {
        ...
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        // Проверяем, что тело ответа содержит пользователя
        assertThat(response.getContentAsString()).contains("Smith", "Doe", "Simpson");
    }
    ...
    void testUpdatePerson() throws Exception {
        ...
        // Создаем данные обновленной компании
        PersonDto dto = new PersonDto();
        dto.setFirstName("Carl");
        dto.setLastName("Lager");
        ...
        // Проверяем статус ответа
        // Проверяем, что тело ответа содержит пользователя
        assertThat(response1.getContentAsString()).contains("Carl");
        assertThat(response1.getContentAsString()).contains("Lager");
    }
